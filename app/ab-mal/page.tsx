...
export default function AbMalPage() {
  ...
  return (
    <main className="w-full bg-white text-slate-900 pt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center w-full relative z-10">
          ...
          <div className="lg:col-span-7 space-y-8">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-xs font-bold text-emerald-600 uppercase tracking-widest"
            >
            ...
            >
              <div className="bg-slate-100 border border-slate-200 rounded-2xl px-6 py-4 flex items-center gap-4">
                <div>
                  <p className="text-[10px] text-slate-500 uppercase font-bold tracking-wider">Cabinet Pack Price</p>
          ...
          >
            ...
            <div className="relative h-full w-full rounded-3xl overflow-hidden border border-slate-200 shadow-2xl bg-slate-50 p-4">
              ...
              <div className="absolute bottom-8 left-8 right-8 p-5 bg-white/90 backdrop-blur-md border border-slate-200 rounded-2xl flex justify-between items-center text-xs">
                <div>
                  <p className="text-slate-400 uppercase font-bold tracking-widest text-[9px] mb-1">Active compounds</p>
                  <p className="font-bold text-slate-900">100% Herbal Extracts</p>
                </div>
                <div className="text-right">
                  <p className="text-slate-400 uppercase font-bold tracking-widest text-[9px] mb-1">Research origin</p>
                  <p className="font-bold text-emerald-600">ABUAD Bogoro Centre</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-20 px-6 bg-emerald-50 border-b border-emerald-100">
        <div className="max-w-4xl mx-auto bg-white border border-slate-200 rounded-3xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-slate-900">Why buying anti-malarials during chills is a bad strategy</h3>
      ...
      <section className="py-24 px-6 border-b border-slate-100">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center max-w-xl mx-auto">
            ...
            <p className="text-slate-500 text-sm mt-3">Simple 3-step preventive and therapeutic household protocol.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {product.howItWorks.map((item, idx) => (
              <div key={idx} className="bg-slate-50 border border-slate-200 rounded-3xl p-8 relative flex flex-col justify-between hover:border-emerald-400 transition-colors">
      ...
      <section className="py-20 px-6 bg-slate-50 border-b border-slate-100">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
          <div className="lg:w-1/2 space-y-6">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-100 text-[10px] font-bold text-emerald-700 uppercase tracking-widest">
              Scientific Evidence
            </div>
            <h3 className="text-3xl font-extrabold text-slate-900">Clinical Credentials & Lab Validation</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
                <p className="text-lg font-bold text-slate-900">Bogoro Institute</p>
                <p className="text-[11px] text-slate-500">Developed & manufactured in certified laboratories</p>
              </div>
              <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
                <p className="text-lg font-bold text-slate-900">NAFDAC Regulated</p>
                <p className="text-[11px] text-slate-500">Produced in compliance with clinical safety rules</p>
              </div>
            </div>
          </div>
          
          <div className="lg:w-1/2 w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-6 bg-white rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between min-h-[160px]">
              <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Active Agent 01</p>
              <p className="text-sm font-bold text-slate-900">Red Blood Cell Protection</p>
              <p className="text-xs text-slate-500">Helps protect vital red blood cells from parasite invasion pathways.</p>
            </div>
            <div className="p-6 bg-white rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between min-h-[160px]">
              <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Active Agent 02</p>
              <p className="text-sm font-bold text-slate-900">Liver Stage Defense</p>
              <p className="text-xs text-slate-500">Botanical bioactives support liver cells during internal detoxification cycles.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="checkout-section" className="py-24 px-6 max-w-4xl mx-auto">
        <div className="text-center max-w-xl mx-auto mb-12">
          <h2 className="text-3xl font-extrabold text-slate-900">Order AB-MaL Shield</h2>
          <p className="text-slate-500 text-sm mt-2">Get free shipping to any destination in Nigeria. Securely processed via Paystack.</p>
        </div>
