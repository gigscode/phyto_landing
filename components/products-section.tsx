...
export function ProductsSection() {
  return (
    <section id="products" className="w-full py-28 px-4 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          <p className="text-emerald-400 font-bold text-sm tracking-widest uppercase mb-3">
          ...
          {products.map((product, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className={`relative overflow-hidden rounded-3xl bg-slate-950 border border-white/5 shadow-xl group-hover:shadow-2xl transition-all duration-500 p-5 flex flex-col justify-between h-full ${cardTheme}`}>
                    <div>
                      {/* Product Image Panel */}
                      <div className="relative aspect-[4/5] overflow-hidden rounded-2xl mb-6 bg-slate-900 border border-white/5">
                        <motion.img
                        ...
                        />
                        <div className="absolute top-4 left-4 px-3 py-1 bg-slate-950/80 backdrop-blur-md rounded-full border border-white/10 text-[10px] font-bold text-white uppercase tracking-wider">
                          {product.badge}
                        </div>
                        <div className="absolute top-4 right-4 h-9 w-9 bg-slate-950/80 backdrop-blur-md rounded-full flex items-center justify-center border border-white/10 text-yellow-400">
